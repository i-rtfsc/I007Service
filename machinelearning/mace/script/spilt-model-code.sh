...
cp $MACE_DIR/build/mobilenet_v1_quant/model/$TARGET_ABI/mobilenet_v1_quant.a $LIBRARY_MODEL_DIR/$TARGET_ABI
...
#cp $MACE_DIR/build/mobilenet_v2_quant/model/$TARGET_ABI/mobilenet_v2_quant.a $LIBRARY_MODEL_DIR/$TARGET_ABI

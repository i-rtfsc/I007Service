...
public class DebugUtils {
    public static final String TAG = "I007";
    public final static boolean BUILD_TYPE = "eng".equals(Build.TYPE) || "userdebug".equals(Build.TYPE);
    private static final boolean DEBUG_FOR_USER = false;
    public static final boolean DEBUG = Log.isLoggable(TAG, Log.DEBUG) || BUILD_TYPE || DEBUG_FOR_USER;

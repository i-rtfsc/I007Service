...
public abstract class LiteProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        try {
            LiteSQLHelper dbHelper = new LiteSQLHelper(getContext(), getDatabaseFileName(),
                    getSchemaVersion()) {
                ...
                public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
                    ...
                    // behaviour
                    LiteProvider.this.onUpgrade(db, oldVersion, newVersion);
                }
    ...
    protected String getDatabaseFileName() {
        ...
        return names[names.length - 1] + ".db";
    }

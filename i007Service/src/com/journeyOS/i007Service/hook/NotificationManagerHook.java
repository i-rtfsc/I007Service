...
public class NotificationManagerHook extends Hook implements InvocationHandler {
    private static final String TAG = NotificationManagerHook.class.getSimpleName();
    ...
    public void setOnNotificationMethodListener(MethodInvokeListener listener) {
    ...
    public void onHook(ClassLoader classLoader) throws Throwable {
        ServiceManagerHook serviceManagerHook = new ServiceManagerHook(mContext, Context.NOTIFICATION_SERVICE);
        ...
        if (originBinder instanceof IBinder) {
            mOriginObj = IINotificationManagerCompat.asInterface((IBinder) originBinder);

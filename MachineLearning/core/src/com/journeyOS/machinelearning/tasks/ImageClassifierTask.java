 ...
 * @author solo
 */
public class ImageClassifierTask extends BaseTask {
    public static final String TASK_NAME = ImageClassifierTask.class.getSimpleName();
     ...
     */
    public ImageClassifierTask(int clientId, Worker worker, String taskName, AiData aiData) {
